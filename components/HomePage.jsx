...
const HomePage = () => {
  ...
  const socialLinks = [
    { Index: "1", Title: "Twitter", Icon: <CiTwitter />, Link: "https://twitter.com/alanzhang003" },
    { Index: "2", Title: "LinkedIn", Icon: <CiLinkedin />, Link: "https://www.linkedin.com/in/alan-zhang-a254b8233/" },
    { Index: "3", Title: "GitHub", Icon: <FaGithub />, Link: "https://github.com/alanzhang03" },
    { Index: "4", Title: "Email", Icon: <MdOutlineEmail />, Link: "mailto:alan.s.zhang04@gmail.com" },
    { Index: "5", Title: "Instagram", Icon: <FaInstagram />, Link: "https://www.instagram.com/_alanzhang_3/" },
  ];
        ...
        <div className="hero-right">
          <div className="profile-photo-container">
            <Image
              ...
              priority
              onClick={() => window.open("https://www.linkedin.com/in/azhang03/", "_blank")}
            />
          </div>
        </div>
      </div>

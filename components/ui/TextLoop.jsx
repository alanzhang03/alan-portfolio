	...
	return (
		<div className="container" ref={containerRef}>
			<ul className="v-slides">
				<li className="v-slide">{splitTextToLetters("Websites")}</li>
				<li className="v-slide">{splitTextToLetters("Plugins")}</li>
				<li className="v-slide">{splitTextToLetters("Web Apps")}</li>
				<li className="v-slide">{splitTextToLetters("Portals")}</li>
				<li className="v-slide">{splitTextToLetters("Communities")}</li>
